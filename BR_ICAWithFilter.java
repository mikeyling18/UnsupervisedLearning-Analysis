...
public class BR_ICAWithFilter {
    public static void main(String args[]) throws Exception{
        //load dataset
        DataSource source = new DataSource("wisconsin_ica.arff");
...
//        System.out.println(dataset);
        ...
        FileWriter writer = new FileWriter("wisconsin_ica_accuracy.csv", true);
