...
class KMeansTestCluster():
    def __init__(self, X, y, clusters, plot=True, targetcluster=26, stats=False):
        self.X = X
        self.y = y
    ...
    def run(self):
        ...
        for k in self.clusters:
            model = KMeans(n_clusters=k, max_iter=750, init='k-means++')
    ...
    def plot(self, meandist, homogeneity, completeness, rand, silhouettes, accuracy):
            ...
            plt.title('Letter Recognition K-Means: Average Within Cluster SSE vs Number of Clusters')
            #plt.show()
            ...
            plt.title('Letter Recognition K-Means: Homogeneity vs Number of Clusters')
           # plt.show()
            ...
            plt.title('Letter Recognition K-Means: Completeness vs Number of Clusters')
            plt.show()
            ...
            plt.xlabel('Number of clusters')
            plt.ylabel('Accuracy')
            plt.title('Letter Recognition K-Means: Accuracy vs Number of Clusters')
            plt.show()
            ...
            plt.title('Letter Recognition K-Means: Adjusted Rand Score vs Number of Clusters')
            plt.show()
