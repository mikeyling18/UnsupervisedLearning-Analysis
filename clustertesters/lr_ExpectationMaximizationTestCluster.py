...
class ExpectationMaximizationTestCluster():
    ...
    def run(self):
        ...
        if self.gen_plot:
            #self.visualize()
            self.plot(ll, homogeneity_scores, completeness_scores, rand_scores, bic, aic, accuracy)
    ...
    def plot(self, ll, homogeneity, completeness, rand, bic, aic, accuracy):
            # """
            ...
            plt.title('Letter Recognition EM - Log Probability vs Number of Clusters')
            #plt.show()
            ...
            plt.title('Letter Recognition EM - Homogeneity vs Number of Clusters')
            #plt.show()
            ...
            plt.title('Letter Recognition EM - RAND Score vs. Number of Clusters')
            plt.show()
            ...
            plt.xlabel('Number of clusters')
            plt.ylabel('Accuracy')
            plt.title('Letter Recognition EM - Accuracy vs Number of Clusters')
            plt.show()